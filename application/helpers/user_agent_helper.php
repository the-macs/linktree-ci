...
if (!function_exists('user_agent')) {
    ...
    function user_agent() {
        ...
        $getloc = json_decode(curl("http://ipinfo.io/"));
        
        $exist_url = $getloc !== NULL;

        $result['client_ip'] = $exist_url ? $getloc->ip : null;
        $result['city'] = $exist_url ? $getloc->city : null;
        $result['region'] = $exist_url ? $getloc->region : null;
        $result['country'] = $exist_url ? $getloc->country : null;
        $result['loc'] = $exist_url ? $getloc->loc : null;
